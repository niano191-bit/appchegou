...
export const metadata = {
  title: "Entrar — Restaurante",
  description: "Login da loja para gerenciar pedidos e cardápio.",
};

export default async function LoginRestaurantePage({
  searchParams,
}: {
