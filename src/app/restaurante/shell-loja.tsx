...
const ITENS: { id: SecaoLoja; label: string }[] = [
...
/** Layout da área da loja: menu à esquerda + conteúdo */
export function ShellLoja({ nome, secao, onSecao, children }: Props) {
  const [menuAberto, setMenuAberto] = useState(false);
  const titulo = ITENS.find((i) => i.id === secao)?.label ?? "Loja";
